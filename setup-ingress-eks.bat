...
REM Usando hostNetwork para que o controller use a rede do host (worker nodes)
REM Isso permite que o NLB do Terraform encaminhe tráfego diretamente para os nós
REM SEM criar um LoadBalancer adicional
